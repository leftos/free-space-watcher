...
/// <summary>The tray's command line: <c>--theme light|dark|system</c> and <c>--open alerts|settings|status</c>, in any order.</summary>
...
public sealed record TrayArguments(TrayTheme Theme, TrayWindow? Open, IReadOnlyList<string> Problems)
{
    ...
    /// <summary>Parses the command line; unknown arguments, unknown values and switches missing their value are ignored and reported.</summary>
    ...
    public static TrayArguments Parse(IReadOnlyList<string> args)
    {
        ...
        return new TrayArguments(theme, open, problems);
    }
